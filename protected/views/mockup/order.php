		...
		<div id="page">
			...
			<div class="container">
				<ul class="breadcrumb p-0">
					...
					<li class="active">Antrag S026 2015</li>
				</ul>
			</div>
									...
									<ul class="nav nav-tabs row request-order-nav">
										<li class="active project"> 
											<a href="#project" data-toggle="tab" aria-expanded="false">
												<span class="hidden-xs">Projektdaten</span> 
											</a> 
										</li>
										<li class="finance"> 
											<a href="#finance" data-toggle="tab" aria-expanded="false">
												<span class="hidden-xs">Finanzplan</span> 
											</a> 
										</li>
										<li class="concepts"> 
										...
										<li class="schools-goals"> 
											<a href="#schools-goals" data-toggle="tab" aria-expanded="false">
												<span class="hidden-xs">Entwicklungsziele</span> 
											</a> 
										</li>
									</ul>
								</div>
														...
														<div class="col-lg-4">
															<div class="heading-date">
																...
																<div class="holder-head-date custom-dl  m-t-10">
																	...
																	<div class="btn-row">
																		<button class="btn m-t-5" data-target="#modal-3" data-toggle="modal">Datum ändern</button>
																	</div>
																</div>
															</div>
														</div>
