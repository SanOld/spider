						...
						<div class="panel panel-default">
							<div class="panel-heading clearfix">
								...
								<div class="pull-right heading-box-print">
									...
									<button class="btn w-lg custom-btn" data-target="#modal-2" data-toggle="modal">Bezirk hinzufügen</button>
								</div>
							</div>
...
<!--Edit schoole -->
		...
		<div id="modal-1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-width-full schoole-modal">
				<div class="panel panel-color panel-primary">
					<div class="panel-heading clearfix"> 
						<h3 class="m-0 pull-left">Bezirk bearbeiten - Wilhelm-Busch-Grundschule (10G08)</h3>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="ion-close-round "></i></button>
					</div>
					<div class="panel-body p-t-0">
						<div class="row">
							<ul class="nav nav-tabs row"> 
								...
								<li> 
									<a href="#school" data-toggle="tab" aria-expanded="false">
										<span class="hidden-xs">Schulen</span> 
									</a> 
								</li>
							</ul>
						</div>
