...
<html lang="en">
	<head>
		...
		<title>E-Mail-Vorlagen | SPIder</title>
		...
		<div id="page">
			...
			<div class="container">
				<ul class="breadcrumb p-0">
					...
					<li class="active">E-Mail-Vorlagen</li>
				</ul>
			</div>
...
<!--Edit Doc templ  -->
		...
		<div id="modal-1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-width-full">
				<div class="panel panel-color panel-primary">
					<div class="panel-heading clearfix"> 
						<h3 class="m-0 pull-left">E-Mail-Vorlagen bearbeiten - FV_2013_Sonderkündigung </h3>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="ion-close-round "></i></button>
					</div>
								...
								<form role="form">
									<div class="row m-t-30">
										<div class="m-b-15 clearfix">
											...
											<div class="col-lg-11">
												FV_2013_Sonderkündigung
											</div>
										</div>
										<div class="m-b-15 clearfix">
											<label class="col-lg-1 control-label">Beschreibung:</label>
											<div class="col-lg-11">
												Comes to TA user which responsible for financing plan if there are comments on the Financing plan
											</div>
										</div>
										<div class="m-b-15 clearfix">
						                    <div class="col-sm-12">
					                            <div class="panel-body"> 
					                                <div class="summernote">
														...
														Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.  {KENNZIFFER} Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
