...
<html lang="en">
	<head>
		...
		<title>Benutzerliste | SPIder</title>
						...
						<div class="panel panel-default">
							<div class="panel-heading clearfix">
								...
								<div class="pull-right heading-box-print">
									...
									<button class="btn w-lg custom-btn" data-target="#modal-2" data-toggle="modal">Benutzer hinzufügen</button>
								</div>
							</div>
											...
											<form action="#" class="class-form">
												...
												<div class="col-lg-4 add">
													<div class="form-group">
														...
														<input type="text" placeholder="Organisationsname eingeben" class="search-relation form-control">
													</div>
												</div>
												<div class="col-lg-2">
													<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-4 custom-width">
									<button data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-placement="top" data-toggle="popover" title="" data-container="body" class="has-hint btn btn-question" type="button" data-original-title="" aria-describedby="popover332715" data-trigger="focus">
								  	...
								  	<div class="wrap-hint wrap-line error">
...
<!--Edit user -->
		...
		<div id="modal-1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
				<div class="panel panel-color panel-primary">
					<div class="panel-heading clearfix"> 
						<h3 class="m-0 pull-left">Benutzerprofil editieren</h3>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="ion-close-round "></i></button>
					</div>
					<div class="alert alert-danger m-t-20">
	                    Bitte geben Sie die markierten Felder korrekt ein. 
	                </div>
					<h3 class="subheading">Benutzer Info</h3>
					<hr>
					<div class="panel-body">
						<form role="form" class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<div class="col-lg-9"> 
											...
											<div class="wrap-hint wrap-line error">
												<input class="form-control" type="text" id="username" value="jack.nik">
												<label class="error" for="username">Bitte geben Sie Benutzername ein</label>
												<span class="glyphicon glyphicon-remove form-control-feedback"></span>
											</div>
										</div>
									</div>
								...
								<div class="form-custom-box clearfix">
									...
									<div class="col-lg-4">
										...
										<div class="wrap-line error">
											<input class="form-control" type="text" id="phone" value="">
											<label class="error" for="username">Neues Passwort wiederholen</label>
											<span class="glyphicon glyphicon-remove form-control-feedback"></span>
										</div>
									</div>
								</div>
