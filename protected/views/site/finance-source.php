...
<!--                            <select class="form-control">
                          ...
                          <ui-select ng-disabled="!$select.items.length" ng-model="finance.finance_source_type" name="finance_source_type" required>
                    ...
                    <div class="m-b-15 clearfix">
                        ...
                        <div class="col-lg-9" ng-class="{'wrap-line error': fieldError('programm')}">
                            ...
                            <span ng-show="fieldError('programm')">
                                <label ng-show="formFinances.programm.$error.required" class="error">Programm is required.</label>
