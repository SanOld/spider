	<div class="panel panel-color panel-primary" >
		<div class="panel-heading clearfix">
			<h3 class="m-0 pull-left" >Druck-Template bearbeiten - {{document.name}} #{{docId}}</h3>
                  ...
                  <div class="m-b-15 clearfix">
                    ...
                    <div class="col-lg-3">
                      ...
                      <div class="wrap-hint" ng-class="{'wrap-line error': fieldError('type_id')}">
                        <ui-select  class="type-document" ng-model="document.type_id" required name="type_id" ng-change="updateGrid()">
