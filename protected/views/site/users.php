		...
		<div class="container center-block">
            ...
            <button class="custom-btn btn w-xs" export-to-csv ng-click="">csv Export</button>
				...
				<div class="panel-body edit-user">
                    ...
                    <div class="col-lg-4 add2">
                      <div class="form-group">
                        <label>Suche<small> (Namen, Benutzernamen oder E-Mail)</small></label>
                    ...
                    <div class="col-lg-{{canByType(['a','p','t'])?2:6}} add">
                      <div class="form-group">
                    ...
                    <div class="col-lg-1" ng-if="canByType(['a','p','t'])">
                      <div class="form-group">
                        <label>Status</label>
