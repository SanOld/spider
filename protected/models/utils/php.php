...
class qqFileUploader {
  ...
  function __construct(array $allowedExtensions = array(), $sizeLimit = 10485760, array $params = array('renameFiles'=>false)) {
  ...
  function handleUpload($uploadDirectory, $replaceOldFile = FALSE) {
    ...
    if($this -> params['renameFiles']) {
      $filename = $this -> renameFile($pathinfo['filename']);
    }
