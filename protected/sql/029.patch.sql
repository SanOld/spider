CREATE TABLE `spi_request_school_goal` (
	...
	`capacity` TINYINT(1) NOT NULL DEFAULT '0' COMMENT '0-не цель;  1-другая; 2 - приоритетная',
	...
	`other_description` TEXT NULL,
        `offer_field_count` TINYINT(2) NOT NULL DEFAULT '0',
	...
	`concept` TINYINT(1) NOT NULL DEFAULT '0',
        `net_other_goal` TINYINT(1) NOT NULL DEFAULT '0',
	`network_text` TEXT NULL,
        `net_field_count` TINYINT(2) NOT NULL DEFAULT '0',
