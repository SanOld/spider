...
INSERT INTO spi_page (code, name, is_real_page, is_system) VALUES ('document_template_type', 'Druck-Templates-Type', 0, 1);
SELECT @page_id:=id FROM `spi_page` WHERE `code`= 'document_template_type';
